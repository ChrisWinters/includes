...
/**
 * Registers the includes post type with predefined args.
 */
function postType(): void
{
    \register_post_type(
        'includes',
        [
            ...
            'labels' => [
                ...
                'archives' => __('Include archives', 'includes'),
                'attributes' => __('Include attributes', 'includes'),
                'items_list' => __('Include list', 'includes'),
                'items_list_navigation' => __('Include list navigation', 'includes'),
