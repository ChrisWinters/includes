...
abstract class Abstract_Shortcode {
	 ...
	 */
	final public function init( $args = array() ) {
		...
		$this->required_params( $args, array( 'shortcodes', 'posttype', 'taxonomy' ) );
	 ...
	 * @return void
	 */
	abstract protected function shortcode( $atts = array(), $content = null );
