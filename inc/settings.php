...
function settings(string $key): string|array
{
    $settings = [
        ...
        'files' => [
            ...
            '/functions/admin/notices.php',
            '/functions/admin/queryString.php',
            '/functions/admin/securityCheck.php',
            '/functions/admin/metabox/add.php',
            '/functions/admin/metabox/editor.php',
            '/functions/admin/metabox/save.php',
            '/functions/admin/metabox/shortcode.php',
            '/functions/admin/post/actions.php',
            '/functions/admin/post/delete.php',
            '/functions/admin/post/redirect.php',
            '/functions/admin/post/object.php',
            '/functions/admin/post/update.php',
            '/functions/admin/posttype/columnCategory.php',
            '/functions/admin/posttype/columnContent.php',
            '/functions/admin/posttype/columnShortcode.php',
            '/functions/admin/posttype/modifyColumns.php',
            '/functions/admin/taxonomy/formField.php',
            '/functions/admin/view/displayAdmin.php',
