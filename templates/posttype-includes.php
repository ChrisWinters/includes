 ...
 */
$includes_posttype_key = sanitize_key( filter_input( INPUT_GET, 'post_type', FILTER_SANITIZE_ENCODED, FILTER_FLAG_STRIP_HIGH ) );
$includes_postid       = absint( filter_input( INPUT_GET, 'post', FILTER_SANITIZE_NUMBER_INT ) );
...
if ( true === post_type_exists( $includes_posttype_key ) ) {
	 ...
	 */
	$html = apply_filters( 'the_content', get_post_field( 'post_content', $includes_postid ) );
