...
<?php if ( includes_fs()->is_not_paying() ) { ?>
		<li class="font-weight-bold">→ <a href="<?php echo esc_url( site_url( 'wp-admin' ) ); ?>/edit.php?post_type=includes&page=includes-pricing"><?php esc_html_e( 'Upgrade For Awesome Features!', 'includes' ); ?></a></li>
<?php } ?>
		<li>&bull; <a href="<?php echo esc_url( site_url( 'wp-admin' ) ); ?>/edit.php?post_type=includes&page=includes-contact"><?php esc_html_e( 'Contact Support', 'includes' ); ?></a></li>
